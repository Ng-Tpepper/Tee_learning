...
CREATE DATABASE "DQL_CLASSPROJECT"
USE DQL_CLASSPROJECT
...
VALUES (1, 'Beverages', 'Beverages, coffees, teas');
INSERT INTO CATEGORIES
VALUES (2, 'Condiments', 'Sauces, seasonings, and spices');
INSERT INTO CATEGORIES
VALUES (3, 'Desserts', 'Desserts and sweets');
INSERT INTO CATEGORIES
VALUES (4, 'Dairy Products', 'Cheeses');
INSERT INTO CATEGORIES
VALUES (5, 'Pasta and Cereals', 'Breads, biscuits, pasta, and cereals');
INSERT INTO CATEGORIES
VALUES (6, 'Meats', 'Prepared meats');
INSERT INTO CATEGORIES
VALUES (7, 'Dry Products', 'Dried fruits, raisins, others');
INSERT INTO CATEGORIES
VALUES (8, 'Fish and Seafood', 'Fish, seafood, snails');
INSERT INTO CATEGORIES
VALUES (9, 'Computer Equipment', 'Laptops, keyboards, mice');
...
--Showing my workings up here as i understand the instructions given:

-- displaying male employees with a net salary >= 8000, ordered by seniority

SELECT EMPLOYEE_NUMBER,(FIRST_NAME, 30) AS FIRST_NAME,(LAST_NAME, 40) AS LAST_NAME,DATEDIFF(YEAR, BIRTH_DATE, GETDATE()) AS AGE,DATEDIFF(YEAR, HIRE_DATE, GETDATE()) AS SENIORITY
FROM 
    EMPLOYEES
WHERE 
...
-- Products Meeting Specific Criteria
SELECT 
    PRODUCT_REF,
    PRODUCT_NAME,
    SUPPLIER_NUMBER,
...
-- Customers Residing in the Same Region as Supplier 1
SELECT *
FROM CUSTOMERS
WHERE 
    (COUNTRY, CITY, RIGHT(POSTAL_CODE, 3)) IN 
    (SELECT 
...
-- Suppliers of Beverage Products
SELECT 
    SUPPLIER_NUMBER,
    COMPANY,
    ADDRESS,
...
FROM 
    SUPPLIERS 
WHERE 
    PRODUCT_REF IN (SELECT PRODUCT_REF FROM PRODUCTS WHERE CATEGORY_CODE = 'beverage');


-- Customers from Berlin with 0 or 1 Dessert Product Ordered
SELECT 
    CUSTOMER_CODE
FROM 
    CUSTOMERS
WHERE 
    CITY = 'Berlin' 
    AND (SELECT COUNT(*) FROM ORDERS O WHERE O.CUSTOMER_CODE = C.CUSTOMER_CODE AND O.PRODUCT_TYPE = 'Dessert') <= 1;


-- Customers from France and Total Amount of Orders Every Monday in April 1998
SELECT 
    C.CUSTOMER_NUMBER,
    C.COMPANY_NAME,
    C.PHONE_NUMBER,
...
GROUP BY 
    C.CUSTOMER_NUMBER, C.COMPANY_NAME, C.PHONE_NUMBER, C.COUNTRY;


-- Customers Who Have Ordered All Products
SELECT 
    CUSTOMER_CODE,
    COMPANY_NAME,
    PHONE_NUMBER
    ...
    NOT EXISTS (
        ...
        WHERE 
            NOT EXISTS (
                SELECT *
                FROM ORDERS O
                WHERE O.PRODUCT_REF = P.PRODUCT_REF AND O.CUSTOMER_CODE = C.CUSTOMER_CODE
            )
);


-- Number of Orders from Customers in France
SELECT 
    CUSTOMER_CODE,
...
VALUES ('ALFKI', 'Alfreds Futterkiste', 'Obere Str. 57', 'Berlin', '12209', 'Germany', '030-0074321', '030-0076545');
INSERT INTO CUSTOMERS
VALUES ('ANATR', 'Ana Trujillo Emparedados y helados', 'Avda. de la Constitución 2222', 'México D.F.', '05021', 'Mexico', '(5) 555-4729', '(5) 555-3745');
INSERT INTO CUSTOMERS
VALUES ('ANTON', 'Antonio Moreno Taquería', 'Mataderos 2312', 'México D.F.', '05023', 'Mexico', '(5) 555-3932', '');
INSERT INTO CUSTOMERS
VALUES ('AROUT', 'Around the Horn', '120 Hanover Sq.', 'London', 'WA1 4SD', 'United Kingdom', '(71) 555-7788', '(71) 555-6750');
INSERT INTO CUSTOMERS
VALUES ('BERGS', 'Berglunds snabbköp', 'Berguvsvägen 8', 'Luleå', 'S-958 22', 'Sweden', '0921-12 34 65', '0921-12 34 67');
INSERT INTO CUSTOMERS
VALUES ('BLAUS', 'Blauer See Delikatessen', 'Forsterstr. 57', 'Mannheim', '68306', 'Germany', '0621-08460', '0621-08924');
INSERT INTO CUSTOMERS
VALUES ('BLONP', 'Blondel père et fils', '24, place Kléber', 'Strasbourg', '67000', 'France', '03.88.60.15.31', '03.88.60.15.32');
INSERT INTO CUSTOMERS
VALUES ('BOLID', 'Bólido Comidas preparadas', 'Araquil, 67', 'Madrid', '28023', 'Spain', '(91) 555 22 82', '(91) 555 91 99');
INSERT INTO CUSTOMERS
VALUES ('BONAP', 'Bon app''étit', '12, rue des Bouchers', 'Marseille', '13008', 'France', '04.91.24.45.40', '04.91.24.45.41');
INSERT INTO CUSTOMERS
VALUES ('BOTTM', 'Bottom-Dollar Markets', '23 Tsawassen Blvd.', 'Tsawassen', 'T2F 8M4', 'Canada', '(604) 555-4729', '(604) 555-3745');
INSERT INTO CUSTOMERS
VALUES ('BSBEV', 'B''s Beverages', 'Fauntleroy Circus', 'London', 'EC2 4SD', 'United Kingdom', '(71) 555-1212', '');
INSERT INTO CUSTOMERS
VALUES ('CACTU', 'Cactus Comidas para llevar', 'Cerrito 333', 'Buenos Aires', '1010', 'Argentina', '(1) 135-5555', '(1) 135-4892');
INSERT INTO CUSTOMERS
VALUES ('CENTC', 'Centro comercial Moctezuma', 'Sierras de Granada 9993', 'México D.F.', '05022', 'Mexico', '(5) 555-3392', '(5) 555-7293');
INSERT INTO CUSTOMERS
VALUES ('CHOPS', 'Chop-suey Chinese', 'Hauptstr. 29', 'Bern', '3012', 'Switzerland', '0452-076545', '');
INSERT INTO CUSTOMERS
VALUES ('COMMI', 'Comércio Mineiro', 'Av. dos Lusíadas, 23', 'São Paulo', '05432-043', 'Brazil', '(11) 555-7647', '');
INSERT INTO CUSTOMERS
VALUES ('CONSH', 'Consolidated Holdings', 'Berkeley Gardens 12 Brewery', 'London', 'WX1 4SD', 'United Kingdom', '(71) 555-2282', '(71) 555-9199');
INSERT INTO CUSTOMERS
VALUES ('DRACD', 'Drachenblut Delikatessen', 'Walserweg 21', 'Aachen', '52066', 'Germany', '0241-039123', '0241-059428');
INSERT INTO CUSTOMERS
VALUES ('DUMON', 'Du monde entier', '67, rue des Cinquante Otages', 'Nantes', '44000', 'France', '02.40.67.88.88', '02.40.67.89.89');
INSERT INTO CUSTOMERS
VALUES ('EASTC', 'Eastern Connection', '35 King George', 'London', 'WX3 6FW', 'United Kingdom', '(71) 555-0297', '(71) 555-3373');
INSERT INTO CUSTOMERS
VALUES ('ERNSH', 'Ernst Handel', 'Kirchgasse 6', 'Graz', '8010', 'Austria', '7675-3425', '7675-3426');
INSERT INTO CUSTOMERS
VALUES ('FAMIA', 'Familia Arquibaldo', 'Rua Orós, 92', 'São Paulo', '05442-030', 'Brazil', '(11) 555-9857', '');
INSERT INTO CUSTOMERS
VALUES ('FISSA', 'FISSA Fabrica Inter. Salchichas S.A.', 'Moralzarzal, 86', 'Madrid', '28034', 'Spain', '(91) 555 94 44', '(91) 555 55 93');
INSERT INTO CUSTOMERS
VALUES ('FOLIG', 'Folies gourmandes', '184, chaussée de Tournai', 'Lille', '59000', 'France', '03.20.16.10.16', '03.20.16.10.17');
INSERT INTO CUSTOMERS
VALUES ('FOLKO', 'Folk och fä HB', 'Åkergatan 24', 'Bräcke', 'S-844 67', 'Sweden', '0695-34 67 21', '');
INSERT INTO CUSTOMERS
VALUES ('FRANK', 'Frankenversand', 'Berliner Platz 43', 'München', '80805', 'Germany', '089-0877310', '089-0877451');
INSERT INTO CUSTOMERS
VALUES ('FRANR', 'France restauration', '54, rue Royale', 'Nantes', '44000', 'France', '02.40.32.21.21', '02.40.32.21.20');
INSERT INTO CUSTOMERS
VALUES ('FRANS', 'Franchi S.p.A.', 'Via Monte Bianco 34', 'Torino', '10100', 'Italy', '011-4988260', '011-4988261');
INSERT INTO CUSTOMERS
VALUES ('FURIB', 'Furia Bacalhau e Frutos do Mar', 'Jardim das rosas n. 32', 'Lisboa', '1675', 'Portugal', '(1) 354-2534', '(1) 354-2535');
INSERT INTO CUSTOMERS
VALUES ('GALED', 'Galería del gastrónomo', 'Rambla de Cataluña, 23', 'Barcelona', '08022', 'Spain', '(93) 203 4560', '(93) 203 4561');
INSERT INTO CUSTOMERS
VALUES ('GODOS', 'Godos Cocina Típica', 'Romero, 33', 'Sevilla', '41101', 'Spain', '(95) 555 82 82', '');
INSERT INTO CUSTOMERS
VALUES ('GOURL', 'Gourmet Lanchonetes', 'Av. Brasil, 442', 'Campinas', '04876-786', 'Brazil', '(11) 555-9482', '');
INSERT INTO CUSTOMERS
VALUES ('GREAL', 'Great Lakes Food Market', '2732 Baker Blvd.', 'Eugene', '97403', 'United States', '(503) 555-7555', '');
INSERT INTO CUSTOMERS
VALUES ('GROSR', 'GROSELLA-Restaurante', '5ª Ave. Los Palos Grandes', 'Caracas', '1081', 'Venezuela', '(2) 283-2951', '(2) 283-3397');
INSERT INTO CUSTOMERS
VALUES ('HANAR', 'Hanari Carnes', 'Rua do Paço, 67', 'Rio de Janeiro', '05454-876', 'Brazil', '(21) 555-0091', '(21) 555-8765');
INSERT INTO CUSTOMERS
VALUES ('HILAA', 'HILARIÓN-Abastos', 'Carrera 22 con Ave. Carlos Soublette #8-35', 'San Cristóbal', '5022', 'Venezuela', '(5) 555-1340', '(5) 555-1948');
INSERT INTO CUSTOMERS
VALUES ('HUNGC', 'Hungry Coyote Import Store', 'City Center Plaza 516 Main St.', 'Elgin', '97827', 'United States', '(503) 555-6874', '(503) 555-2376');
INSERT INTO CUSTOMERS
VALUES ('HUNGO', 'Hungry Owl All-Night Grocers', '8 Johnstown Road', 'Cork', '2506', 'Ireland', '2967 542', '2967 3333');
INSERT INTO CUSTOMERS
VALUES ('ISLAT', 'Island Trading', 'Garden House Crowther Way', 'Cowes', 'PO31 7PJ', 'United Kingdom', '(198) 555-8888', '');
INSERT INTO CUSTOMERS
VALUES ('KOENE', 'Königlich Essen', 'Maubelstr. 90', 'Brandenburg', '14776', 'Germany', '0555-09876', '');
INSERT INTO CUSTOMERS
VALUES ('LACOR', 'La corne d''abondance', '67, avenue de l''Europe', 'Versailles', '78000', 'France', '01.30.59.84.10', '01.30.59.85.11');
INSERT INTO CUSTOMERS
VALUES ('LAMAI', 'La maison d''Asie', '1 rue Alsace-Lorraine', 'Toulouse', '31000', 'France', '05.61.77.61.10', '05.61.77.61.11');
INSERT INTO CUSTOMERS
VALUES ( 'LAUGB','Laughing Bacchus Wine Cellars','1900 Oak St.','Vancouver','V3F 2K1','Canada','(604) 555-3392','(604) 555-7293' );
INSERT INTO CUSTOMERS
VALUES ( 'LAZYK','Lazy K Kountry Store','12 Orchestra Terrace','Walla Walla','99362','États-Unis','(509) 555-7969','(509) 555-6221' );
INSERT INTO CUSTOMERS
VALUES ( 'LEHMS','Lehmanns Marktstand','Magazinweg 7','Frankfurt a.M. ','60528','Allemagne','069-0245984','069-0245874' );
INSERT INTO CUSTOMERS
VALUES ( 'LETSS','Let''s Stop N Shop','87 Polk St.Suite 5','San Francisco','94117','États-Unis','(415) 555-5938','' );
INSERT INTO CUSTOMERS
VALUES ( 'LILAS','LILA-Supermercado','Carrera 52 con Ave. Bolívar #65-98 Llano Largo','Barquisimeto','3508','Venezuela','(9) 331-6954','(9) 331-7256' );
INSERT INTO CUSTOMERS
VALUES ( 'LINOD','LINO-Delicateses','Ave. 5 de Mayo Porlamar','I. de Margarita','4980','Venezuela','(8) 34-56-12','(8) 34-93-93' );
INSERT INTO CUSTOMERS
VALUES ( 'LONEP','Lonesome Pine Restaurant','89 Chiaroscuro Rd.','Portland','97219','États-Unis','(503) 555-9573','(503) 555-9646' );
INSERT INTO CUSTOMERS
VALUES ( 'MAGAA','Magazzini Alimentari Riuniti','Via Ludovico il Moro 22','Bergamo','24100','Italie','035-640230','035-640231' );
INSERT INTO CUSTOMERS
VALUES ( 'MAISD','Maison Dewey','Rue Joseph-Bens 532','Bruxelles','B-1180','Belgique','(02) 201 24 67','(02) 201 24 68' );
INSERT INTO CUSTOMERS
VALUES ( 'MEREP','Mère Paillarde','43 rue St. Laurent','Montréal','H1J 1C3','Canada','(514) 555-8054','(514) 555-8055' );
INSERT INTO CUSTOMERS
VALUES ( 'MORGK','Morgenstern Gesundkost','Heerstr. 22','Leipzig','04179','Allemagne','0342-023176','' );
INSERT INTO CUSTOMERS
VALUES ( 'NORTS','North/South','South House300 Queensbridge','London','SW7 1RZ','Royaume-Uni','(71) 555-7733','(71) 555-2530' );
INSERT INTO CUSTOMERS
VALUES ( 'OCEAN','Océano Atlántico Ltda.','Ing. Gustavo Moncada 8585Piso 20-A','Buenos Aires','1010','Argentine','(1) 135-5333','(1) 135-5535' );
INSERT INTO CUSTOMERS
VALUES ( 'OLDWO','Old World Delicatessen','2743 Bering St.','Anchorage','99508','États-Unis','(907) 555-7584','(907) 555-2880' );
INSERT INTO CUSTOMERS
VALUES ( 'OTTIK','Ottilies Käseladen','Mehrheimerstr. 369','Köln','50739','Allemagne','0221-0644327','0221-0765721' );
INSERT INTO CUSTOMERS
VALUES ( 'PARIS','Paris spécialités','265, boulevard Charonne','Paris','75012','France','01.42.34.22.66','01.42.34.22.77' );
INSERT INTO CUSTOMERS
VALUES ( 'PERIC','Pericles Comidas clásicas','Calle Dr. Jorge Cash 321','México D.F.','05033','Mexique','(5) 552-3745','(5) 545-3745' );
INSERT INTO CUSTOMERS
VALUES ( 'PICCO','Piccolo und mehr','Geislweg 14','Salzburg','5020','Autriche','6562-9722','6562-9723' );
INSERT INTO CUSTOMERS
VALUES ( 'PRINI','Princesa Isabel Vinhos','Estrada da saúde n. 58','Lisboa','1756','Portugal','(1) 356-5634','' );
INSERT INTO CUSTOMERS
VALUES ( 'QUEDE','Que Delícia','Rua da Panificadora, 12','Rio de Janeiro','02389-673','Brésil','(21) 555-4252','(21) 555-4545' );
INSERT INTO CUSTOMERS
VALUES ( 'QUEEN','Queen Cozinha','Alameda dos Canàrios, 891','São Paulo','05487-020','Brésil','(11) 555-1189','' );
INSERT INTO CUSTOMERS
VALUES ( 'QUICK','QUICK-Stop','Taucherstraße 10','Cunewalde','01307','Allemagne','0372-035188','' );
INSERT INTO CUSTOMERS
VALUES ( 'RANCH','Rancho grande','Av. del Libertador 900','Buenos Aires','1010','Argentine','(1) 123-5555','(1) 123-5556' );
INSERT INTO CUSTOMERS
VALUES ( 'RATTC','Rattlesnake Canyon Grocery','2817 Milton Dr.','Albuquerque','87110','États-Unis','(505) 555-5939','(505) 555-3620' );
INSERT INTO CUSTOMERS
VALUES ( 'REGGC','Reggiani Caseifici','Strada Provinciale 124','Reggio Emilia','42100','Italie','0522-556721','0522-556722' );
INSERT INTO CUSTOMERS
VALUES ( 'RICAR','Ricardo Adocicados','Av. Copacabana, 267','Rio de Janeiro','02389-890','Brésil','(21) 555-3412','' );
INSERT INTO CUSTOMERS
VALUES ( 'RICSU','Richter Supermarkt','Grenzacherweg 237','Genève','1203','Suisse','0897-034214','' );
INSERT INTO CUSTOMERS
VALUES ( 'ROMEY','Romero y tomillo','Gran Vía, 1','Madrid','28001','Espagne','(91) 745 6200','(91) 745 6210' );
INSERT INTO CUSTOMERS
VALUES ( 'SANTG','Santé Gourmet','Erling Skakkes gate 78','Stavern','4110','Norvège','07-98 92 35','07-98 92 47' );
INSERT INTO CUSTOMERS
VALUES ( 'SAVEA','Save-a-lot Markets','187 Suffolk Ln.','Boise','83720','États-Unis','(208) 555-8097','' );
INSERT INTO CUSTOMERS
VALUES ( 'SEVES','Seven Seas Imports','90 Wadhurst Rd.','London','OX15 4NB','Royaume-Uni','(71) 555-1717','(71) 555-5646' );
INSERT INTO CUSTOMERS
VALUES ( 'SIMOB','Simons bistro','Vinbæltet 34','København','1734','Danemark','31 12 34 56','31 13 35 57' );
INSERT INTO CUSTOMERS
VALUES ( 'SPECD','Spécialités du monde','25, rue Lauriston','Paris','75016','France','01.47.55.60.10','01.47.55.60.20' );
INSERT INTO CUSTOMERS
VALUES ( 'SPLIR','Split Rail Beer  Ale','P.O. Box 555','Lander','82520','États-Unis','(307) 555-4680','(307) 555-6525' );
INSERT INTO CUSTOMERS
VALUES ( 'SUPRD','Suprêmes délices','Boulevard Tirou, 255','Charleroi','B-6000','Belgique','(071) 23 67 22 20','(071) 23 67 22 21' );
INSERT INTO CUSTOMERS
VALUES ( 'THEBI','The Big Cheese','89 Jefferson WaySuite 2','Portland','97201','États-Unis','(503) 555-3612','' );
INSERT INTO CUSTOMERS
VALUES ( 'THECR','The Cracker Box','55 Grizzly Peak Rd.','Butte','59801','États-Unis','(406) 555-5834','(406) 555-8083' );
INSERT INTO CUSTOMERS
VALUES ( 'TOMSP','Toms Spezialitäten','Luisenstr. 48','Münster','44087','Allemagne','0251-031259','0251-035695' );
INSERT INTO CUSTOMERS
VALUES ( 'TORTU','Tortuga Restaurante','Avda. Azteca 123','México D.F.','05033','Mexique','(5) 555-2933','' );
INSERT INTO CUSTOMERS
VALUES ( 'TRADH','Tradição Hipermercados','Av. Inês de Castro, 414','São Paulo','05634-030','Brésil','(11) 555-2167','(11) 555-2168' );
INSERT INTO CUSTOMERS
VALUES ( 'TRAIH','Trail''s Head Gourmet Provisioners','722 DaVinci Blvd.','Kirkland','98034','États-Unis','(206) 555-8257','(206) 555-2174' );
INSERT INTO CUSTOMERS
VALUES ( 'VAFFE','Vaffeljernet','Smagsløget 45','Århus','8200','Danemark','86 21 32 43','86 22 33 44' );
INSERT INTO CUSTOMERS
VALUES ( 'VICTE','Victuailles en stock','2, rue du Commerce','Lyon','69004','France','04.78.32.54.86','04.78.32.54.87' );
INSERT INTO CUSTOMERS
VALUES ( 'VINET','Vinis et Chevalier','59 rue de l''Abbaye','Reims','51100','France','03.26.47.15.10','03.26.47.15.11' );
INSERT INTO CUSTOMERS
VALUES ( 'WANDK','Die Wandernde Kuh','Adenauerallee 900','Stuttgart','70563','Allemagne','0711-020361','0711-035428' );
INSERT INTO CUSTOMERS
VALUES ( 'WARTH','Wartian Herkku','Torikatu 38','Oulu','90110','Finlande','981-443655','981-443655' );
INSERT INTO CUSTOMERS
VALUES ( 'WELLI','Wellington Importadora','Rua do Mercado, 12','Resende','08737-363','Brésil','(14) 555-8122','' );
INSERT INTO CUSTOMERS
VALUES ( 'WHITC','White Clover Markets','305 - 14th Ave. S.Suite 3B','Seattle','98128','États-Unis','(206) 555-4112','(206) 555-4115' );
INSERT INTO CUSTOMERS
VALUES ( 'WILMK','Wilman Kala','Keskuskatu 45','Helsinki','21240','Finlande','90-224 8858','90-224 8858' );
INSERT INTO CUSTOMERs 
VALUES ( 'WOLZA','Wolski  Zajazd','ul. Filtrowa 68','Warszawa','01-012','Pologne','(26) 642-7012','(26) 642-7012' );
INSERT INTO CUSTOMERS
VALUES ( 'MONP','MONOPRIX - SFAX EL AIN','Route d''El Ain Km 1,5 3000 Sfax ','Safx','1003','Tunisie','(26) 642-7012','(26) 642-7012' );
...
-- creating a table called ORDER_DETAILS
...
VALUES (2, 2, 'Fuller', 'Andrew', 'Vice President', 'Dr.', '1952-02-19', '1992-08-14', 10000.00, NULL); 
INSERT INTO EMPLOYEES
VALUES (8, 2, 'Callahan', 'Laura', 'Sales Assistant', 'Miss', '1958-01-09', '1994-03-05', 2000.00, NULL);
INSERT INTO EMPLOYEES
VALUES (4, 2, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '1958-09-19', '1993-05-03', 2856.00, 250.00);
INSERT INTO EMPLOYEES
VALUES (3, 2, 'Leverling', 'Janet', 'Sales Representative', 'Miss', '1963-08-30', '1992-04-01', 3500.00, 1000.00);
INSERT INTO EMPLOYEES
VALUES (1, 2, 'Davolio', 'Nancy', 'Sales Representative', 'Miss', '1968-12-08', '1992-05-01', 3135.00, 1500.00);
INSERT INTO EMPLOYEES
VALUES (5, 2, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '1955-03-04', '1993-10-17', 8000.00, NULL);
INSERT INTO EMPLOYEES
VALUES (9, 5, 'Dodsworth', 'Anne', 'Sales Representative', 'Miss', '1969-07-02', '1994-11-15', 2180.00, 0.00);
INSERT INTO EMPLOYEES
VALUES (6, 5, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '1963-07-02', '1993-10-17', 2534.00, 600.00);
INSERT INTO EMPLOYEES
VALUES (7, NULL, 'King', 'Robert', 'Sales Representative', 'Mr.', '1960-05-29', '1994-01-02', 2356.00, 800.00);
